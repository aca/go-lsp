...
import (
	...
	"github.com/aca/go-lsp/gopls_internal/lsp/command/commandmeta"
...
func Generate() ([]byte, error) {
	...
	d := data{
		...
		Imports: map[string]bool{
			"context": true,
			"fmt":     true,
			"github.com/aca/go-lsp/gopls_internal/lsp/protocol": true,
		},
	}
	const thispkg = "github.com/aca/go-lsp/gopls_internal/lsp/command"
